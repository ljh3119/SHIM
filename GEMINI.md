...
- **Author Email Privacy**: 깃허브 원격 저장소에 Push하기 전, 모든 커밋 작성자의 이메일이 개인 이메일(예: `your_email@users.noreply.github.com`)이 아닌 깃허브 비공개용 이메일(`ljh3119@users.noreply.github.com`)로 설정되었는지 필히 검증해야 합니다.
