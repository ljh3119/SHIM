...
### 핵심 기능
- **정밀한 연차 신청**: 시작/종료 시각 입력 기반 차감 및 정책 단위(30/60/120분) 검증, 그리고 에어비앤비 스타일의 시작일~종료일 **기간 범위 선택(Range Selection)** 및 좌측 간편 신청 입력창과의 실시간 양방향 동기화(Bi-directional Binding, 150ms 디바운싱 탑재) 지원
